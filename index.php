...
<body>  
        ...
        <div class="container-fluid">
          ...
          <a href="#"><form class="d-flex">
            <a href="loginvalidation/Student_Login.php"> 
              <label style="color: black; font-weight:200; margin: 15px;">Select user</label>
    ...
    Welcome to DKTE Bus Pass Management System | Do your Pass Registration on this Offical Portal.  
</marquee>
