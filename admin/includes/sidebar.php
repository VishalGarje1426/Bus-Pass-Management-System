                    ...
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-section-inner">
                                <img src="https://bus.dkte.tech/assets/images/dkte-logo.png" alt="">
                            </div>
                            <div class="user-info">
                                <?php
...
{               ?>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Add Routes<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-category.php">Add New Routes</a>
                            </li>
                            <li>
                                <a href="manage-category.php">Manage Routes</a>

                            </li>
                            <li>
                                <a href="fee.php">fee Details</a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="studentregi.php">Student Registered Pass</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                    <a href="#"><i class="fa fa-files-o fa-fw"></i> Login Details<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="student_account.php">Student Account Details</a>
                            </li>
                            <li>
                                <a href="faculty_account.php">Admin Account Details</a>
                            </li>
